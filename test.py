...
###########################################################################################################################
Training = False  # Set to True for training, False for loading pre-trained model
###########################################################################################################################
...
if Training:
    ...
    # Train the model
    lr_scheduler = tf.keras.callbacks.ReduceLROnPlateau(monitor='loss', factor=0.8, patience=30, min_lr=0.0001)
